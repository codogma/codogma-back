...
@Configuration
@OpenAPIDefinition(info = @Info(title = "IT Blog API", version = "0.9.31", description = "API documentation for IT Blog", contact = @Contact(name = "Email", email = "your.email@example.com"), license = @License(name = "Apache 2.0", url = "http://springdoc.org")), tags = @Tag(name = "Oauth2 authorization", description = "API for OAuth authorization"))
@SecuritySchemes({
